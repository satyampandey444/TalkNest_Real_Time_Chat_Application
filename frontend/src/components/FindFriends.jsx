...
const FindFriends = () => {
  ...
  const fetchFriendsList = async () => {
    try {
      const { data } = await axios.get(
        "http://localhost:3000/api/v1/friends/list",
        { withCredentials: true }
      );
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const { data } = await axios.get(
        `http://localhost:3000/api/v1/user/search?query=${query}`,
        { withCredentials: true }
      );
  ...
  const handleSendRequest = async (userId) => {
    try {
      const { data } = await axios.post(
        `http://localhost:3000/api/v1/friends/send-request/${userId}`,
        {},
        { withCredentials: true }
      );
  ...
  const handleAcceptRequest = async (userId) => {
    try {
      const { data } = await axios.post(
        `http://localhost:3000/api/v1/friends/accept-request/${userId}`,
        {},
        { withCredentials: true }
      );
